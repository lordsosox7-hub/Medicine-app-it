...
const styles = StyleSheet.create({
  ...
  emptyTitle: { fontSize: 16, fontFamily: "Tajawal_700Bold", marginBottom: 6 },
  emptyText: { fontSize: 13, fontFamily: "Tajawal_500Medium", textAlign: "center" },
  ...
  defaultText: { fontSize: 10, fontFamily: "Tajawal_700Bold" },
  addressLine: { fontSize: 12, fontFamily: "Tajawal_500Medium", textAlign: "right", marginTop: 4, lineHeight: 18 },
  setDefault: { padding: 12, alignItems: "center", borderTopWidth: 1 },
  setDefaultText: { fontSize: 13, fontFamily: "Tajawal_700Bold" },
  addBtn: {
    flexDirection: "row", alignItems: "center", justifyContent: "center",
    height: 52, borderRadius: 14, gap: 8, marginTop: 20,
  },
  addText: { fontSize: 15, fontFamily: "Tajawal_700Bold" },
  modalBg: { flex: 1, backgroundColor: "rgba(0,0,0,0.4)", justifyContent: "flex-end" },
  modalCard: { padding: 20, borderTopLeftRadius: 24, borderTopRightRadius: 24, paddingBottom: 32 },
  modalTitle: { fontSize: 18, fontFamily: "Tajawal_700Bold", textAlign: "right", marginBottom: 16 },
  fieldLabel: { fontSize: 13, fontFamily: "Tajawal_700Bold", textAlign: "right", marginBottom: 6 },
  modalInput: {
    height: 48, borderRadius: 12, borderWidth: 1, paddingHorizontal: 14,
    fontSize: 14, fontFamily: "Tajawal_500Medium", textAlign: "right",
  },
  modalActions: { flexDirection: "row", gap: 12, marginTop: 16 },
  modalBtn: { flex: 1, height: 48, borderRadius: 12, alignItems: "center", justifyContent: "center" },
  modalBtnText: { fontSize: 14, fontFamily: "Tajawal_700Bold" },
});
